            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        ...
                        <h1 class="text-center">FORM KRITERIA</h1>
                        <h2 class="text-center">Isi Untuk Kriteria</h2>
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="{{ route('kriteria.store')}}" method="POST">
                                 @csrf
                                ...
                                <div class="form-group">
                                        <input type="text" class="form-control form-control-user"
                                            id="exampleInputPassword" placeholder="Bobot" name="bobot">
                                </div>
                                <div class="form-group">
                                        <!-- <input type="text" class="form-control form-control-user"
                                            id="exampleInputPassword" placeholder="Sertifikat" name="sertifikat">
                                </div>
                                <div class="form-group">
                                        <input type="text" class="form-control form-control-user"
                                            id="exampleInputPassword" placeholder="Project" name="project">
                                </div> -->
